...
/**
 * A mock version of sRIP, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSRIP is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sR.RIP", "sR.RIP") {
