...
contract Distributor is IDistributor, RipProtocolAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    uint256 private immutable rateDenominator = 1000000;
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        return rip.totalSupply().mul(_rate).div(rateDenominator);
    }
